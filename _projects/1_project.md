...
Website fun, idk figure it out bro.

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/rickrolled.jpg" title="rick rolled" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
